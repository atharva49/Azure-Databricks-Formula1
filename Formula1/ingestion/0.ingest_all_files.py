...
v_result = dbutils.notebook.run("6.ingest_pitstop_file",0,{"p_data_source":"Ergast API","p_file_date":"2021-04-18"})
print(v_result)

# COMMAND ----------

v_result = dbutils.notebook.run("7.ingest_lap_time_files",0,{"p_data_source":"Ergast API","p_file_date":"2021-04-18"})
print(v_result)
